        ...
        <div className="flex items-start gap-16">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-6 mt-6">
              ...
              src="https://github.com/pedrocmoreira.png" 
              alt=""
              />

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Pedro Moreira</strong>
                <span className="text-gray-200 text-sm block">React Native Developer</span>
              </div> 
            </div>
          </div>
